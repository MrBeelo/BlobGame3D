...
DrawClock :: proc() {
	...
	FONT_SIZE :: 96
	FONT_SPACING :: 7
	text_size := MeasureText(str, FONT_SIZE, FONT_SPACING, .INSTRUMENT_SERIF)
	DrawTextIndividiShaky(str, {SCREEN_SIZE.x / 2 - text_size.x / 2, 100}, FONT_SIZE, FONT_SPACING, .INSTRUMENT_SERIF, color, 
